<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
      ...
      <el-table-column prop="playback" label="播放量"></el-table-column>
      <el-table-column prop="size" label="文件大小(MB)"></el-table-column>
  ...
  methods: {
    load() {
      this.request.get("/file/page", {
        ...
        // 只显示戏曲信息
        for (let types = 0; types < res.data.records.length; types++) {
          const element = res.data.records[types];
